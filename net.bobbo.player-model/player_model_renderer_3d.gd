## A node that renders a PlayerModel3D and allows for easy swapping.
...
var _current_model: PlayerModel3D = null
...
## Args:
##	`new_model_scene`: The packed `PlayerModel3D` scene that will be rendered.
...
## Returns the currently rendered PlayerModel3D, or null if there is none.
func get_model() -> PlayerModel3D:
	return _current_model


## Returns the source scene of the currently rendered PlayerModel3D, or null if
## there is none.
