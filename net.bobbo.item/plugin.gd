...
func _enter_tree():
	...
	add_custom_type("WorldItem2D", "RigidBody2D", preload("world_item_2d.gd"), preload("icons/item.png"))
	add_custom_type("WorldItem3D", "RigidBody3D", preload("world_item_3d.gd"), preload("icons/item.png"))
